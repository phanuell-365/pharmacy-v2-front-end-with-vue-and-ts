<template>
  ...
  <form ref="formRef" class="row g-3 m-4" novalidate @submit.prevent>
    ...
    <!--  SupplierId  -->
    <InputContainer :invalid-feedback="SupplierIdErrorMessage" input-id="SupplierId" input-label="SupplierId">
      <select
    ...
    <!--  orderQuantity  -->
    <InputContainer :invalid-feedback="orderQuantityErrorMessage" input-id="orderQuantity" input-label="orderQuantity">
      <input
        id="validationOrderQuantity"
        v-model.trim="orderQuantity"
        :class="{'is-invalid': !orderQuantityMeta.valid && orderQuantityMeta.validated}"
        class="form-control"
        name="orderQuantity"
        required
        type="text"
    ...
    <!--  status  -->
    <InputContainer :invalid-feedback="statusErrorMessage" input-id="status" input-label="status">
      <select
        id="validationStatus"
        v-model.trim="status"
...
const orderQuantityValidation = (value: string) => {
  ...
  if (!useIsNumeric(value))
    return "The order quantity should be a number";
